  ...
  return (
    <div clasName="container">
        ...
        <div className="recommendations">
          <div className='Recommend1s'>
            <div className='Title1s'>제목</div>
            <div> <Link to='/Main' className='gotoMain'>메인화면으로 돌아가기</Link></div>
          </div>

          <div className='Recommend2s'>
            <div className='Title2s'>제목</div>
            <div> <Link to='/Profile' className='saveMyPage'>결과 My Page 저장하기</Link></div>
          </div>
        </div>
      </div>
